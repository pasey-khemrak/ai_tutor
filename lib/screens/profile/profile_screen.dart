...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  void _saveProfile() {
    ...
    setState(() {
      ...
      _savedGrade = _gradeLevel ?? 'Not set';
      _isEditing = false;
      _saved = true;
    });
...
class SettingsView extends StatelessWidget {
  ...
  Future<void> _openGoalDialog(BuildContext context) async {
    await showDialog<void>(
      context: context,
      builder: (_) =>
          LearningGoalDialog(goal: goal, onGoalChanged: onGoalChanged),
    );
  }
...
class SettingsRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final rowIconColor = iconColor == AppColors.subtle
        ? ProfilePalette.subtle(context)
        : iconColor;
